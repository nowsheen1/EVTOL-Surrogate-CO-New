...
%% PREPARATION
function [z]=smbo_3(rPropg,Vg,mtowg,Sg,rpmg,eta_motorg,m_gbg) 
rng(100);
...
n_smp = 70;                  % Number of samples for each iteration
...
conffn = str2func('conf3');  % Obtain function handle for configurations
...
objfn = @(xopt)obj3(xopt,rPropg,Vg,mtowg,Sg,rpmg,eta_motorg,m_gbg);
confn1 = @(xopt)con3(xopt,rPropg,Vg,mtowg,Sg,rpmg,eta_motorg,m_gbg);
