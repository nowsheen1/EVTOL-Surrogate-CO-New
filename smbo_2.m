...
%% PREPARATION
function [z]=smbo_2(rpms, eta_motors) 
rng(100);
...
maxiter = 40;               % Maximum number of iterations allowed
n_smp = 20;                  % Number of samples for each iteration
...
objfn = @(xopt)obj2(xopt,rpms, eta_motors);
confn1 = @(xopt)con2(xopt,rpms, eta_motors);
